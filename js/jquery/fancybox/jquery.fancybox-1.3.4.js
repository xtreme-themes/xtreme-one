 ...
 *
 *
 * Patched to work proper with iPad, iPhone, iPod and Android
 *   based on http://groups.google.com/group/fancybox/browse_thread/thread/c1535b2bdefcad58/507ec578bb5347fa
 *   integrated for xtreme framework
**/
		...
		_show = function() {
			...
			if (currentOpts.overlayShow) {
				overlay.css({
					...
					'width' : $(document).width() //patched for iPad, iPhone, iPod and Android
				});
